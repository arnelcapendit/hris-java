...
<html>
  <head>
    ...
    <link rel="stylesheet" href="/ASDI/assets/ASDI/css/shifts_and_schedules/new_schedule.css">
  </head>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            <i class="fa fa-dashboard"></i> New Schedule
          </h1>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  ...
                  <div class="box-tools">
                    <a href="/ASDI/shifts_and_schedules.jsp" class="btn btn-default">Back</a>
                  </div>
                </div>
    ...
    <script src="/ASDI/assets/ASDI/js/shifts_and_schedules/new_schedule.js"></script>
  </body>
</html>